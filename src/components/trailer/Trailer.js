        ...
        <div className={trailer ? ' hidden' : 'bg-[rgba(23,26,33,.95)] z-50 fixed h-screen w-screen top-0 left-0'}>
            <div className="flex items-center justify-center h-full ">
                <div  ref={ele_video} className='relative'>
                    ...
                    <iframe className='lg:w-[850px] lg:h-[450px] md:w-[600px] md:h-[350px] sm:w-[550px] sm:h-[300px] w-[440px] h-[280px]' src={src} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    )
